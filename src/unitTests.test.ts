import { checkIfCanSendTheNotification } from "./controllers/checkIfCanSendTheNotification";
...
test("checkIfCanSendTheNotification returns true for valid input", () => {
    ...
    expect(checkIfCanSendTheNotification("23:00", "22:00", "2025-07-28T21:01:00Z")).toBe(true);
});
...
test("checkIfCanSendTheNotification returns false for invalid input", () => {
    ...
    expect(checkIfCanSendTheNotification("23:59", "22:00", "2025-07-28T22:01:00Z")).toBe(false);
});
...
test("checkIfCanSendTheNotification returns false for invalid input. Midnight crossing 1", () => {
    ...
    expect(checkIfCanSendTheNotification("09:00", "23:22", "2025-07-28T23:59:00Z")).toBe(false);
});
...
test("checkIfCanSendTheNotification returns false for invalid input. Midnight crossing 2", () => {
    ...
    expect(checkIfCanSendTheNotification("09:00", "23:22", "2025-07-28T02:19:00Z")).toBe(false);
});
...
test("checkIfCanSendTheNotification returns false for invalid input. Midnight crossing and event time equals to start time", () => {
    ...
    expect(checkIfCanSendTheNotification("09:00", "23:22", "2025-07-28T23:22:00Z")).toBe(false);
});
...
test("checkIfCanSendTheNotification returns true for valid input. Midnight crossing", () => {
    ...
    expect(checkIfCanSendTheNotification("02:00", "22:00", "2025-07-28T21:59:00Z")).toBe(true);
});
...
test("checkIfCanSendTheNotification returns true for valid input. Midnight crossing 2", () => {
    ...
    expect(checkIfCanSendTheNotification("02:00", "22:00", "2025-07-28T10:10:00Z")).toBe(true);
});
...
describe("preference api testing", () =>{    
    ...
    const invalidPreference1: string = "2312"
